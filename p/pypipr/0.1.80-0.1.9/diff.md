# Comparing `tmp/pypipr-0.1.80.tar.gz` & `tmp/pypipr-0.1.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pypipr-0.1.80.tar", max compression
+gzip compressed data, was "pypipr-0.1.9.tar", max compression
```

## Comparing `pypipr-0.1.80.tar` & `pypipr-0.1.9.tar`

### file list

```diff
@@ -1,6 +1,9 @@
--rw-r--r--   0        0        0        0 2022-10-24 06:22:00.291550 pypipr-0.1.80/pypipr/__init__.py
--rw-r--r--   0        0        0    18477 2023-05-14 02:37:11.423296 pypipr-0.1.80/pypipr/pypipr.py
--rw-r--r--   0        0        0      615 2023-05-14 02:42:07.109567 pypipr-0.1.80/pyproject.toml
--rw-r--r--   0        0        0    11696 2023-05-14 02:40:28.901005 pypipr-0.1.80/README.md
--rw-r--r--   0        0        0    12554 1970-01-01 00:00:00.000000 pypipr-0.1.80/setup.py
--rw-r--r--   0        0        0    11792 1970-01-01 00:00:00.000000 pypipr-0.1.80/PKG-INFO
