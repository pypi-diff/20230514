# Comparing `tmp/emr-sfn-waiter-0.0.1.tar.gz` & `tmp/emr-sfn-waiter-0.0.2.tar.gz`
...
## Comparing `emr-sfn-waiter-0.0.1.tar` & `emr-sfn-waiter-0.0.2.tar`
...
### Comparing `emr-sfn-waiter-0.0.1/LICENSE` & `emr-sfn-waiter-0.0.2/LICENSE`

 * *Files identical despite different names*

### Comparing `emr-sfn-waiter-0.0.1/PKG-INFO` & `emr-sfn-waiter-0.0.2/PKG-INFO`
...
### Comparing `emr-sfn-waiter-0.0.1/setup.py` & `emr-sfn-waiter-0.0.2/setup.py`
...
### Comparing `emr-sfn-waiter-0.0.1/src/emr_sfn_waiter.egg-info/PKG-INFO` & `emr-sfn-waiter-0.0.2/src/emr_sfn_waiter.egg-info/PKG-INFO`
