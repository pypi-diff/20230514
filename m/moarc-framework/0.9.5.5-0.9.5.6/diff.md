# Comparing `tmp/moarc-framework-0.9.5.5.tar.gz` & `tmp/moarc-framework-0.9.5.6.tar.gz`
...
### Comparing `moarc-framework-0.9.5.5/LICENSE` & `moarc-framework-0.9.5.6/LICENSE`
