# Comparing `tmp/local-bert-python-backend-0.0.12.tar.gz` & `tmp/local-bert-python-backend-0.0.2.tar.gz`
...
## Comparing `local-bert-python-backend-0.0.12.tar` & `local-bert-python-backend-0.0.2.tar`
...
### Comparing `local-bert-python-backend-0.0.12/setup.py` & `local-bert-python-backend-0.0.2/setup.py`
